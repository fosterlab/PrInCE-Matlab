...
fprintf (fid_final_1,'%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,\n',...
  'Unique interactions','Protein A','Protein B','Center A',...
  'Center B','Replicate','Delta Height', 'Delta Center','Delta Width',...
  'Delta EucDist', 'Both proteins in Corum', 'Interaction in Corum','Interaction score'); %Write Header
for ix=1:Total_unique_interactions
  fprintf(fid_final_1,'%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%d,%d,%6.4f,\n',...
