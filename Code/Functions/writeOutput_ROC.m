...
Precision_values = precision_range * 100;
...
for write_out_loop2=1:Total_unique_interactions
  ...
  fprintf(Inter_pre_rep,'%6.3f,',str2double(interaction_final.CenterA{write_out_loop2,1}));
  fprintf(Inter_pre_rep,'%6.3f,',str2double(interaction_final.CenterB{write_out_loop2,1}));
  ...
  fprintf(Inter_pre_rep,'%6f,',str2double(interaction_final.proteinInCorum{write_out_loop2,1}));
  fprintf(Inter_pre_rep,'%6f,',str2double(interaction_final.interactionInCorum{write_out_loop2,1}));
...
fprintf (fid_final_1,'%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,\n',...
...
for ix=1:Total_unique_interactions
  fprintf(fid_final_1,'%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,\n',...
    interaction_final.unique_interactions{ix,1},...
    interaction_final.proteinA{ix,1}{1},...
    interaction_final.proteinB{ix,1}{1},...
    interaction_final.centerA_formated{ix,1},...
    interaction_final.centerB_formated{ix,1},...
    interaction_final.Replicates_formated{ix,1},...
    interaction_final.DeltaHeight_formated{ix,1},...
    interaction_final.DeltaCenter_formated {ix,1},...
    interaction_final.Deltawidth_formated{ix,1},...
    interaction_final.DeltaEuc_formated{ix,1},...
    interaction_final.proteinInCorum{ix,1},...
    interaction_final.interactionInCorum{ix,1});
end
fclose(fid_final_1);
